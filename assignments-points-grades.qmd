...
## Assignments and Points (486 points)[^assignments-points-grades-1]

[^assignments-points-grades-1]: see makeup policies

In this class we emphasize _process_ over _product_ - and because this is a 5000-level course which encourages use of all available resources, I will expect you to learn through your own reading, writing, and experience in addition to materials from lecture and class activities. In other words, lecture in this class is not designed to spoon-feed you everything you need to know. We will use the [course textbook @sec-textbook] as a basic scaffold for most of the information but will be building our own wiki-style textbook as we go throughout the semester. 
...
**Weekly Reading Annotations, Wiki Contributions, and Lecture Quizzes (86 points, 13% of your grade)**

Each week, you will be asked to complete required readings, largely from Vepraskas and Craft, 2016. To encourage [slow reading @sec-reading] I will ask that you provide an active reading audit trail in the form of annotations and marginalia (either physical or digital). Additionally, each week you will be asked to contribute a minimum of 5 researched citations and 3 pieces of content (either full pages or sections) which you will turn in using a [wiki-contribution log](https://docs.google.com/spreadsheets/d/1gRmGtMAoqWovaImaEfK-w8DJwKZDGL7ErcGff5PhSyI/edit?usp=sharing). Your reading annotations and wiki-contributions will be due on Friday of each week. Finally, there will be short quizzes in lecture each week. These will typically be given on Wednesday, but can be taken the following Monday for credit in the case of an absence. These are learning assessments meant to understand how well concepts are being absorbed and understood in the class.  These will be graded for completion, not accuracy (14 Reading Audits x 2 points + 14 wiki contributions x 2 points + 15 quizzes x 2 points = 86 points).
