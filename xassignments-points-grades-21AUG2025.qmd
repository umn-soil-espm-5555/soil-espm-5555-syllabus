...
## Activities and Assignments (486 points)[^assignments-points-grades-1]
...
The activities and assignments in this class are designed around a few organizing principles:
...
**Weekly Reading Annotations and Wiki Contributions, and Lecture Quizzes (56 points, 13% of your grade)**
...
Assignments won't be given points directly, but rather will be assigned a categorical assessment (according to a rubric specific to each assignment). These categorical assessments will be converted into points as follows:

E (Exemplary Effort) = 5
S (Strong Effort) = 4
D (Developing Effort) = 3
N (Needs More Effort) = 2
Z (Zero Effort) = 1

These points are what will show up in your Canvas grade book for each assignment. Assignments are then weighted according to the learning assessment category they are assigned to as follows:

*Conceptual Understanding*: Midterm Exam, Final Exam

*Field and Lab Skills*: Field Trip Reports (x3), Redox Vial Project

*Data Interpretation and Analysis*: Soil Hydrology Exercise, Wetland Assessment Exercise, Hydric Soils Exercise

*Creativity and Communication*: Wetland Case Study, Biochemistry Exercise

*Engagement and Growth* : Reading Annotations, Wiki Contributions

*Group Collaboration and Contribution* (25%): Group Hydric Soil Delineation Project, In-Class Wetland Assessment
